...
>
    <div id="bg-validation-input" x-show="!escapeEnabled" class="fixed inset-0 flex items-center justify-center z-[100] bg-white dark:bg-black bg-opacity-30 select-none">
        <div class="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center">
            <div class="flex items-center">
                <span class="text-xl font-bold animate-pulse mt-20 ml-12 bg-gray-300 bg-opacity-60 px-1 border border-black border-opacity-30 rounded">
                Cargando
                </span>
    ...
    <livewire:module.cost.update-cost.calculate-absolute-frequency-component wire:key="cafc-1"/>

    <livewire:module.cost.update-cost.verify-exchange-rate-component wire:key="overc-1"/>

    <livewire:module.cost.update-cost.index-update-cost-component wire:key="iupdc-1"/>

    <livewire:module.validation.confirm-validation-modal-component wire:key="figure13-1"/>

    <livewire:module.validation.dichotomic-asking-modal-component wire:key="dicho-ask"/>
